...
from fcbykcli.api import R, create_spa
...
def start_web_server(port: int, service: LansendService, run_server: bool = True):
    ...
    # 获取 fcbykcli.web.dist 目录的绝对路径
    # 使用包根路径计算 web/dist 目录（web 不是 Python 模块，只是资源目录）
    package_root = Path(__file__).parent.parent.parent  # fcbykcli 包根目录
