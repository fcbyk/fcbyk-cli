...
from fcbykcli.infra.daemon import (
    DaemonRecord,
    _daemon_dir,
    _extract_port,
    _list_pid_files,
...
class TestStartDaemon:
    @patch("fcbykcli.infra.daemon.subprocess.Popen")
    @patch("fcbykcli.infra.daemon._write_record")
    @patch("fcbykcli.infra.daemon._pid_file")
...
class TestListDaemons:
    @patch("fcbykcli.infra.daemon._list_pid_files")
    @patch("fcbykcli.infra.daemon._read_record")
    @patch("fcbykcli.infra.daemon._process_exists")
...
class TestStopByPid:
    ...
    @patch("fcbykcli.infra.daemon._read_record")
    @patch("fcbykcli.infra.daemon._process_exists")
    @patch("fcbykcli.infra.daemon._terminate")
...
class TestKillDaemonCallback:
    ...
    @patch("fcbykcli.infra.daemon.build_runtime")
    @patch("fcbykcli.infra.daemon.stop_by_pid")
    @patch("fcbykcli.infra.daemon.list_daemons")
